...
```
cd existing_repo
git remote add origin https://gitlab.com/mservices-node-ts/boilerplate-node-mongo-ts.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mservices-node-ts/boilerplate-node-mongo-ts/-/settings/integrations)
...
request for maintainers. Jest use debugger //npx jest --runInBand Jest use
debugger //npx jest --detectOpenHandles
